const projects = [
  {
    name: "IntegraPI",
    urls: [
      { name: "Web", url: "https://integrapi.projetointegrador.caf.ufv.br" },
      {
        name: "API",
        url: "https://api-integrapi.projetointegrador.caf.ufv.br/api-docs",
      },
    ],
    img: "/assets/integrapi.png",
  },
  {
  ...
  {
    name: "Cavaleirinho Jonny: O Resgate de Binny",
    urls: [
      {
        name: "GitHub",
        url: "https://github.com/SabrinaBruni28/Cavaleirinho-Jonny-O-Resgate-de-Binny",
      },
      {
        name: "Web",
        url: "https://sabrinabruni28.github.io/Cavaleirinho-Jonny-O-Resgate-de-Binny/",
      },
      {
        name: "Download (Linux)",
        url: "https://github.com/SabrinaBruni28/Cavaleirinho-Jonny-O-Resgate-de-Binny/releases/latest/download/Cavaleiro-Linux.tar.gz",
      },
      {
        name: "Download (Windows)",
        url: "https://github.com/SabrinaBruni28/Cavaleirinho-Jonny-O-Resgate-de-Binny/releases/latest/download/Cavaleiro-Windows.exe",
      },
    ],
